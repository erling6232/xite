...
#else
static int init_pot_surf(inband, outband, fixed_points)
     IBAND inband;
     IR_BAND outband;
     IBAND fixed_points;
#endif
...
#else
static int interp_pot_surf(inband, outband, fixed_points, 
		    beta, max_iterations)
     IBAND inband;
     IBAND outband;
     IBAND fixed_points;
...
#else
static int Interp_edge (thinned, smoothed)
     IBAND thinned;
     IBAND smoothed;
#endif
{
...
int bin_yb (IBAND inband, IBAND outband, int threshold,
	    ...
	    int max_iterations)
#else
int bin_yb (inband, outband, threshold,
	    beta, 
	    max_iterations)
     IBAND inband;
     IBAND outband;
